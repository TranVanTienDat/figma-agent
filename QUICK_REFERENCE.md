...
| `figma-agent/pages/[page]/[section]/` | UI section data (JSON, Specs, Images)        |
...
2. **Deep Dive**: `/get-figma-info [section_page] [link]` → Populates `pages/[page]/[section]/data.json`.
3. **Build**: `/figma-build [section_page] [link]` → Outputs `.tsx` code in your project.
4. **Audit**: `/figma-audit [section_page] [link]` → Refines code for perfect matching.
